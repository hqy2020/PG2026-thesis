"""Generate the ADM Module figure (F06) via the image2 API.

Reads ``assets/prompts/method_fig_adm_image2_prompt.md`` and saves the returned
PNG to ``assets/fig/method_fig_adm.png``.
"""
...
PROMPT_FILE = REPO_ROOT / "assets" / "prompts" / "method_fig_adm_image2_prompt.md"
OUTPUT_FILE = REPO_ROOT / "assets" / "fig" / "method_fig_adm.png"
