"""Generate the SPS Module figure (F04) via the image2 API.

Reads ``assets/prompts/method_fig_sps_image2_prompt.md`` and saves the returned
PNG to ``assets/fig/method_fig_sps.png``.

Usage:
    export IMAGE2_API_KEY="sk-xxxx"
    python assets/scripts/method_fig_sps_image2_call.py
"""
...
PROMPT_FILE = REPO_ROOT / "assets" / "prompts" / "method_fig_sps_image2_prompt.md"
OUTPUT_FILE = REPO_ROOT / "assets" / "fig" / "method_fig_sps.png"
