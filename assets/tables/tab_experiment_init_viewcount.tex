...
\caption{%
  ...
  outperforms random initialization at all sparsity levels; the full \spags\ further gains from \gap\
  ...
  \spags\ leads at every sparsity level; the relative advantage over \rtwo\ is largest at 3 views,
...
\textbf{\spags}\ (full) & \best{21.44} & \best{28.22} & \best{29.20} \\
\bottomrule
\end{tabular}%
}
\vspace{3pt}
...
\textbf{\spags}\ (Ours) & \best{21.44} & \best{28.22} & \best{29.20} \\
\bottomrule
\end{tabular}%
}
\vspace{3pt}
